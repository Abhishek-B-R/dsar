...
| `examples/nextjs-deletion-webhook`   | Next.js App Router route that verifies outbound webhooks and mock-deletes on `request_fulfilled` | Copy this when wiring erasure to DSAR fulfilment |
